    ...
    try {
      ...
      while (!cancelledRef.current) {
        ...
        if (data.status === "success") {
          ...
          toast({
          title: "Port found",
          description: `${robotType} arm uses ${data.port}.`,
          });
          ...
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-400">
                Disconnect the USB cable. LeLab will find the port for you.
              </p>
            </div>
      ...
      <DialogContent className="bg-gray-900 border-gray-800 text-white sm:max-w-[500px] p-8">
        <DialogHeader>
          ...
          <DialogDescription className="text-gray-400 text-center">
            LeLab watches which port disappears when you unplug the arm.
          </DialogDescription>
        </DialogHeader>

    ...
    <>
      ...
      {!isPrimary && (
        <div
          ...
          aria-modal="true"
        >
          <div className="mx-4 max-w-md space-y-4 rounded-lg border border-slate-700 bg-slate-950 p-6 text-center text-slate-100 shadow-2xl shadow-black/40">
            <h2 className="text-lg font-semibold text-slate-100">
              LeLab is already open in another tab
            </h2>
            <p className="text-sm text-slate-400">
              Only one tab can control the robot at a time. Switch back to the
              original tab, or use this tab instead.
            </p>

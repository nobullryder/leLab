      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-slate-300">
            LeLab is {behind}.
            <br />
            Update when you are ready to get the latest fixes.
            {status.compare_url && (
              <>
                {" "}
                <a
          ...
          <div className="flex items-center justify-between gap-3 pt-1">
            <label className="flex items-center gap-2 text-sm text-slate-300">
              <Checkbox
                ...
                className="border-slate-600 data-[state=checked]:border-cyan-400 data-[state=checked]:bg-cyan-400 data-[state=checked]:text-slate-950"
              />
              Don't ask me again
            </label>

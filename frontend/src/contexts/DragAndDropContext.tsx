...
export const DragAndDropProvider: React.FC<DragAndDropProviderProps> = ({
  ...
  return (
    <DragAndDropContext.Provider value={value}>
      {children}
      {isDragging && (
        <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center bg-[var(--amber-soft)] backdrop-blur-sm">
          <div className="plate ticked p-8 text-center">
            <div className="mb-3 font-display text-2xl font-semibold text-foreground">Drop URDF files</div>
